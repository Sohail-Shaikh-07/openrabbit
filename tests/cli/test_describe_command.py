...
from cli.commands.describe import (
    _build_prompt as _build_describe_prompt,
)
...
async def test_run_describe_uses_prepared_controls_for_context_model_and_publish(
    ...
    async def fake_generator(*args: object, **kwargs: object) -> PullRequestDescription:
        generator_payloads.append(args[0])
        model_prompts.append(
            _build_describe_prompt(args[0], kwargs["retrieval_result"], kwargs["pr_history"])
        )
